...
import ToolsOceanDistance from "./OceanDistance.jsx";
import OceanDistanceResult from "./components/Results.jsx";

export default {
  title: "Tools/OceanDistance"
};

export const page = () => {
  return (
    <MockedProvider mocks={[]} addTypename={false}>
      <PageHolder main="ToolsOceanDistance">
        <ToolsOceanDistance />
      </PageHolder>
    </MockedProvider>
  );
...
export const results = () => {
  ...
  return (
    <PageHolder main="ToolsRouteInsight">
      <OceanDistanceResult insight={insight} />
    </PageHolder>
  );
};
